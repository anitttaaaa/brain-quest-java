...
public class Task15 {
    ...
    public static void task15() {
        ...
        System.out.println("Enter the number of test cases (T), followed by T integers. " +
                "Each integer will be checked to determine which primitive data types can store it.");
...
we'll work with the primitives used to hold integer values
...
Explanation
 ...
 21333333333333333333333333333333 is very large and is outside of the allowable range of values
